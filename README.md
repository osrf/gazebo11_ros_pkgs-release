## gazebo11_ros_pkgs (melodic) - 2.8.7-1

The packages in the `gazebo11_ros_pkgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --track melodic --ros-distro melodic gazebo11_ros_pkgs --edit` on `Fri, 01 May 2020 20:13:47 -0000`
...
## gazebo11_ros_pkgs (melodic) - 2.8.6-4

The packages in the `gazebo11_ros_pkgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release gazebo11_ros_pkgs --track melodic --ros-distro melodic --no-pull-request --edit` on `Fri, 01 May 2020 18:15:01 -0000`
...
## gazebo11_ros_pkgs (melodic) - 2.8.6-3

The packages in the `gazebo11_ros_pkgs` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --no-pull-request --rosdistro melodic --track melodic gazebo11_ros_pkgs` on `Fri, 01 May 2020 11:13:54 -0000`
